...
static int virt_mfd_subdev2_probe(struct platform_device *pdev)
{
...
static int virt_mfd_subdev2_remove(struct platform_device *pdev)
{
    printk("%s\n", __func__);
    return 0;
}
...
static struct platform_driver virt_mfd_subdev_driver = {
    ...
    .probe = virt_mfd_subdev2_probe,
    .remove = virt_mfd_subdev2_remove,
};
